...
%%
initCobraToolbox(false) % don't update
...
%% 
% Let us plot the distributions of interactions for all dietary conditions 
% combined on the level of genera as an example. Note: The xticklabels/yticklabels 
% function is only available in MATLAB R2016b or newer. Older versions of MATLAB 
% will be unable to display the labels.
%%
for i=5
...
% the computed Pareto frontier, which represents all possible optimal solutions 
% of simultaneously optimized growth, depends on the metabolic networks of the 
% two joined microbes.
%%
