...
% results from. If tutorial 1 and 1.5 are used, please use the same inputs used 
% in those tutorials. If you downloaded the pre-made tutorial files set the path 
% for the downloaded files as the resultDirectory variable. We will also define 
...
% generation of human-microbiome models as well as the analysis of results towards 
% the end of the tutorial.
% 
% readsTablePath - The path to the the taxonomic reads file containing the amount 
% of reads per taxonomic assignment. Here we will set to
% 
...
% use EUAverageDietNew. If you wish to use a different diet, you can include it 
% as an input.
...
% function succesfully personalised. *Talk where these can be found and what that 
% tells us.* 
...
% HM_CSM5MCXD.mat created in tutorial 1. If you did not run tutorial 1, HM_CSM5MCXD.mat 
...
% reactions linked to mulitple genes...still occur (CHECK DETAILS)* (what does 
% this mean)
% Common Applications
...
% constraining the limits of the solution with a different objective (*To remove?)*
% 
...
% to the flux of the objective (you can also analyse reduced cost) (*This last 
% statement reads like it requires more indepth explanation?)*
% 
...
%% 
% Now we call the function to add the reactions to de HM WBM. Good practice 
% is to save the output model in a different variable name so you will also have 
...
% killer cells is 63.6207 mmol/day. This indicates that both transport reactions 
% are able to carry flux as otherwise vitamin D3 would not be able to reach the 
% cytosol of natural killer cells. For more indepth explanation in the use of 
% optimizeWBModel and solving models please look at tutorial 2.
...
% of optimizeWBModel and solving models please look at tutorial 2.
...
% be used as template to achieve this. In the modelHM now, Thymidine 5'-triphosphate 
...
% * lb:          Array of lower bounds, as we excrete from the body this will 
% be 0
% * ub:          Array of upper bounds, as we excrete from the body this will 
% be 1000000
%% 
