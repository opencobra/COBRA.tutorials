...
% 3 (assigned taxonomy read counts). An overview of the different input variables, 
% how to create an configuration file, and how to run Persephone is found in Tutorial 
% 1.
%% Step 1: Setup
% Here we show which steps are required to set up your device to support the 
% various functions used to create and analyse human-microbiome models for Persephone. 
