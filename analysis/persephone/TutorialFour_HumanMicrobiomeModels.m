%% Persephone Tutorial 4: Creation of human-microbiome whole-body models (mWBMs)
% Authors: Bram Nap, Tim Hensen, Anna Sheehy
% 
% Last updated: April 2026
% 
% In this section we combine the newly created microbiome community models with 
% the previously developed WBMs [1].  We will show the code required to create 
% one mWBM. Later on we will explain which functions to use to generate multiple 
% mWBMs with just one command. Tutorial 1 explains in depth the various variables 
% and how to run Persephone.
% 
...
% If you have not just run tutorial 2 or 3, or you have cleared your
...
% objectives and solving models can be found in tutorial 5.
