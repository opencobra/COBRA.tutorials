...
% solver, such as the |'gurobi' or 'ibm_cplex'| package. For detailed information, 
% refer to The Cobra Toolbox <https://github.com/opencobra/cobratoolbox/blob/master/docs/source/installation/solvers.md 
