%% 
% _The following instructions were slightly adapted from Nature Protocols 
% – Guide to Authors. Only use the headings as indicated below. Save the tutorial 
% with the format tutorial_yourShortTitle.mlx so the continuous integration server 
% can use it for testing the code._
%% Succinct tutorial title
% _The title should succinctly describe the method and, if appropriate, its 
% application. It should be no longer than 30 words._
%% Author(s): First Last, Affiliation
% _Include those who have contributed intellectually and practically to the 
% development of the technique. For all authors please include first name, middle 
% initial (if appropriate), last names, (Institution, Country). _
%% Reviewer(s): 
...
% references)._
%% MATERIALS
% _EQUIPMENT and EQUIPMENT SETUP are the only subheadings that are allowed. 
% You must include at least one of these headings. Within  EQUIPMENT SETUP the 
% title of the reagent or equipment being discussed forms a second level of subheading._
%% EQUIPMENT
% _Include a list of the essential materials. This should include information 
% about the suppliers used for reagents (e.g., Company, web address and catalog 
% number). If you have found that deviations from a particular source code have 
% adverse effects on the outcome of the tutorial this should be made clear by 
% the word ‘CRITICAL’ followed by a brief explanation. Please also highlight any 
% specialist equipment required. Please provide as much information as you can 
% to help users successfully identify the software dependencies, e.g. git repo, 
% or company name, company website, product code. _
%% EQUIPMENT SETUP
% _If you need to include detailed information about specific software, please 
% list in additional optional sections, called EQUIPMENT SETUP. These sections 
% are suitable for details of setup of equipment._
%% PROCEDURE
