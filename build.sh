...
/usr/local/MATLAB/R2024a/bin/matlab -nodisplay -nosplash -nodesktop -r "export('$ABSOLUTE_FILE_PATH', '$HTML_FILE_PATH', 'Format', 'html'); exit;"
echo "Converting to PDF..."
usr/local/MATLAB/R2024a/bin/matlab -nodisplay -nosplash -nodesktop -r "export('$ABSOLUTE_FILE_PATH', '$PDF_FILE_PATH', 'Format', 'html'); exit;"
